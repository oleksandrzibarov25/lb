...
*2. Покращення та додання логіки для патчів*
...
Експеримент B (cond = B, poison = 1): експериментальна умова - бур’яни
...
Peak: у B середній peak ~2480, у A ~655 — тобто у B ти бачиш значно
